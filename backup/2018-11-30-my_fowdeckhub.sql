...
--
-- Host: 127.0.0.1
-- Creato il: Nov 30, 2018 alle 22:14
...
--
CREATE DATABASE IF NOT EXISTS `my_fowdeckhub` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `my_fowdeckhub`;
...
(3269, 'Atom Seikhart / Atom Seikhart, the Shimmering Rabb', 'SDV1', 2, '1WW', 1, 3),
...
(3379, 'Lucifero / Lucifero, l\\''Angelo Caduto del Cordogli', 'SDV5', 11, '3BB', 1, 3),
