		...
		<ul class="panel-controls panel-controls-title">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="#" class="panel-refresh" id="set_filling_widget_panel_refresh"><span class="fa fa-refresh"></span>Refresh</a></li>
		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped">
				...
				function resize_widget() {
					// Bisogna effettuare un resize del widget al termine del caricamento per allineare le barre laterali.
					$("#set_filling_widget_panel_refresh").click();
				}
