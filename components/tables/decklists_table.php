<table class="table <?php echo !isset($show_name) || $show_name ? "datatable" : "datatable_simple"; ?>">
    <thead>
        <tr>
			<?php
            ...
            echo !isset($show_visibility) || $show_visibility ? "<th width=\"80\">Vis.</th>" : "";
    ...
    <tbody>
        ...
        if(isset($decklists) && $decklists["result"] == true) {
            foreach ($decklists["content"] as $value) {
                ...
                echo !isset($show_event) || $show_event ? "    <td>" . $value["Visibility"] . "</td>" : "";
                echo !isset($show_visibility) || $show_visibility ? "    <td>" . $value["Event"] . "</td>" : "";
